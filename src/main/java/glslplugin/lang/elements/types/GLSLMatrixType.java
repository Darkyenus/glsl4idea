...
public class GLSLMatrixType extends GLSLType {
    ...
    public static final Map<GLSLType, GLSLMatrixType[][]> MATRIX_TYPES = new HashMap<>(BaseType.values().length);
    ...
    public boolean isConvertibleTo(GLSLType otherType) {
        if (!(otherType instanceof GLSLMatrixType other)) return false;
