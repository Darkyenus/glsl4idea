// GLSL Built-ins
// Generated on 2022-11-10T20:38:50.798534800Z
...
int findMSB(uvec2 value);
int findMSB(uvec3 value);
int findMSB(uvec4 value);
ivec2 findMSB(uint value);
ivec2 findMSB(uvec2 value);
ivec2 findMSB(uvec3 value);
ivec2 findMSB(uvec4 value);
ivec3 findMSB(uint value);
ivec3 findMSB(uvec2 value);
ivec3 findMSB(uvec3 value);
ivec3 findMSB(uvec4 value);
ivec4 findMSB(uint value);
ivec4 findMSB(uvec2 value);
ivec4 findMSB(uvec3 value);
ivec4 findMSB(uvec4 value);

int floatBitsToInt(float x);
int floatBitsToInt(vec2 x);
int floatBitsToInt(vec3 x);
int floatBitsToInt(vec4 x);
ivec2 floatBitsToInt(float x);
ivec2 floatBitsToInt(vec2 x);
ivec2 floatBitsToInt(vec3 x);
ivec2 floatBitsToInt(vec4 x);
ivec3 floatBitsToInt(float x);
ivec3 floatBitsToInt(vec2 x);
ivec3 floatBitsToInt(vec3 x);
ivec3 floatBitsToInt(vec4 x);
ivec4 floatBitsToInt(float x);
ivec4 floatBitsToInt(vec2 x);
ivec4 floatBitsToInt(vec3 x);
ivec4 floatBitsToInt(vec4 x);

uint floatBitsToUint(float x);
uint floatBitsToUint(vec2 x);
uint floatBitsToUint(vec3 x);
uint floatBitsToUint(vec4 x);
uvec2 floatBitsToUint(float x);
uvec2 floatBitsToUint(vec2 x);
uvec2 floatBitsToUint(vec3 x);
uvec2 floatBitsToUint(vec4 x);
uvec3 floatBitsToUint(float x);
uvec3 floatBitsToUint(vec2 x);
uvec3 floatBitsToUint(vec3 x);
uvec3 floatBitsToUint(vec4 x);
uvec4 floatBitsToUint(float x);
uvec4 floatBitsToUint(vec2 x);
uvec4 floatBitsToUint(vec3 x);
...
float frexp(float x, out ivec2 exp);
float frexp(float x, out ivec3 exp);
float frexp(float x, out ivec4 exp);
vec2 frexp(vec2 x, out int exp);
vec2 frexp(vec2 x, out ivec2 exp);
vec2 frexp(vec2 x, out ivec3 exp);
vec2 frexp(vec2 x, out ivec4 exp);
vec3 frexp(vec3 x, out int exp);
vec3 frexp(vec3 x, out ivec2 exp);
vec3 frexp(vec3 x, out ivec3 exp);
vec3 frexp(vec3 x, out ivec4 exp);
vec4 frexp(vec4 x, out int exp);
vec4 frexp(vec4 x, out ivec2 exp);
vec4 frexp(vec4 x, out ivec3 exp);
...
vec4 imageLoad(iimage1D image, int P);
vec4 imageLoad(uimage1D image, int P);
ivec4 imageLoad(image1D image, int P);
ivec4 imageLoad(iimage1D image, int P);
ivec4 imageLoad(uimage1D image, int P);
uvec4 imageLoad(image1D image, int P);
uvec4 imageLoad(iimage1D image, int P);
uvec4 imageLoad(uimage1D image, int P);
dvec4 imageLoad(image1D image, int P);
dvec4 imageLoad(iimage1D image, int P);
dvec4 imageLoad(uimage1D image, int P);
vec4 imageLoad(image2D image, ivec2 P);
vec4 imageLoad(iimage2D image, ivec2 P);
vec4 imageLoad(uimage2D image, ivec2 P);
ivec4 imageLoad(image2D image, ivec2 P);
ivec4 imageLoad(iimage2D image, ivec2 P);
ivec4 imageLoad(uimage2D image, ivec2 P);
uvec4 imageLoad(image2D image, ivec2 P);
uvec4 imageLoad(iimage2D image, ivec2 P);
uvec4 imageLoad(uimage2D image, ivec2 P);
dvec4 imageLoad(image2D image, ivec2 P);
dvec4 imageLoad(iimage2D image, ivec2 P);
dvec4 imageLoad(uimage2D image, ivec2 P);
vec4 imageLoad(image3D image, ivec3 P);
vec4 imageLoad(iimage3D image, ivec3 P);
vec4 imageLoad(uimage3D image, ivec3 P);
ivec4 imageLoad(image3D image, ivec3 P);
ivec4 imageLoad(iimage3D image, ivec3 P);
ivec4 imageLoad(uimage3D image, ivec3 P);
uvec4 imageLoad(image3D image, ivec3 P);
uvec4 imageLoad(iimage3D image, ivec3 P);
uvec4 imageLoad(uimage3D image, ivec3 P);
dvec4 imageLoad(image3D image, ivec3 P);
dvec4 imageLoad(iimage3D image, ivec3 P);
dvec4 imageLoad(uimage3D image, ivec3 P);
vec4 imageLoad(image2DRect image, ivec2 P);
vec4 imageLoad(iimage2DRect image, ivec2 P);
vec4 imageLoad(uimage2DRect image, ivec2 P);
ivec4 imageLoad(image2DRect image, ivec2 P);
ivec4 imageLoad(iimage2DRect image, ivec2 P);
ivec4 imageLoad(uimage2DRect image, ivec2 P);
uvec4 imageLoad(image2DRect image, ivec2 P);
uvec4 imageLoad(iimage2DRect image, ivec2 P);
uvec4 imageLoad(uimage2DRect image, ivec2 P);
dvec4 imageLoad(image2DRect image, ivec2 P);
dvec4 imageLoad(iimage2DRect image, ivec2 P);
dvec4 imageLoad(uimage2DRect image, ivec2 P);
vec4 imageLoad(imageCube image, ivec3 P);
vec4 imageLoad(iimageCube image, ivec3 P);
vec4 imageLoad(uimageCube image, ivec3 P);
ivec4 imageLoad(imageCube image, ivec3 P);
ivec4 imageLoad(iimageCube image, ivec3 P);
ivec4 imageLoad(uimageCube image, ivec3 P);
uvec4 imageLoad(imageCube image, ivec3 P);
uvec4 imageLoad(iimageCube image, ivec3 P);
uvec4 imageLoad(uimageCube image, ivec3 P);
dvec4 imageLoad(imageCube image, ivec3 P);
dvec4 imageLoad(iimageCube image, ivec3 P);
dvec4 imageLoad(uimageCube image, ivec3 P);
vec4 imageLoad(imageBuffer image, int P);
vec4 imageLoad(iimageBuffer image, int P);
vec4 imageLoad(uimageBuffer image, int P);
ivec4 imageLoad(imageBuffer image, int P);
ivec4 imageLoad(iimageBuffer image, int P);
ivec4 imageLoad(uimageBuffer image, int P);
uvec4 imageLoad(imageBuffer image, int P);
uvec4 imageLoad(iimageBuffer image, int P);
uvec4 imageLoad(uimageBuffer image, int P);
dvec4 imageLoad(imageBuffer image, int P);
dvec4 imageLoad(iimageBuffer image, int P);
dvec4 imageLoad(uimageBuffer image, int P);
vec4 imageLoad(image1DArray image, ivec2 P);
vec4 imageLoad(iimage1DArray image, ivec2 P);
vec4 imageLoad(uimage1DArray image, ivec2 P);
ivec4 imageLoad(image1DArray image, ivec2 P);
ivec4 imageLoad(iimage1DArray image, ivec2 P);
ivec4 imageLoad(uimage1DArray image, ivec2 P);
uvec4 imageLoad(image1DArray image, ivec2 P);
uvec4 imageLoad(iimage1DArray image, ivec2 P);
uvec4 imageLoad(uimage1DArray image, ivec2 P);
dvec4 imageLoad(image1DArray image, ivec2 P);
dvec4 imageLoad(iimage1DArray image, ivec2 P);
dvec4 imageLoad(uimage1DArray image, ivec2 P);
vec4 imageLoad(image2DArray image, ivec3 P);
vec4 imageLoad(iimage2DArray image, ivec3 P);
vec4 imageLoad(uimage2DArray image, ivec3 P);
ivec4 imageLoad(image2DArray image, ivec3 P);
ivec4 imageLoad(iimage2DArray image, ivec3 P);
ivec4 imageLoad(uimage2DArray image, ivec3 P);
uvec4 imageLoad(image2DArray image, ivec3 P);
uvec4 imageLoad(iimage2DArray image, ivec3 P);
uvec4 imageLoad(uimage2DArray image, ivec3 P);
dvec4 imageLoad(image2DArray image, ivec3 P);
dvec4 imageLoad(iimage2DArray image, ivec3 P);
dvec4 imageLoad(uimage2DArray image, ivec3 P);
vec4 imageLoad(imageCubeArray image, ivec3 P);
vec4 imageLoad(iimageCubeArray image, ivec3 P);
vec4 imageLoad(uimageCubeArray image, ivec3 P);
ivec4 imageLoad(imageCubeArray image, ivec3 P);
ivec4 imageLoad(iimageCubeArray image, ivec3 P);
ivec4 imageLoad(uimageCubeArray image, ivec3 P);
uvec4 imageLoad(imageCubeArray image, ivec3 P);
uvec4 imageLoad(iimageCubeArray image, ivec3 P);
uvec4 imageLoad(uimageCubeArray image, ivec3 P);
dvec4 imageLoad(imageCubeArray image, ivec3 P);
dvec4 imageLoad(iimageCubeArray image, ivec3 P);
dvec4 imageLoad(uimageCubeArray image, ivec3 P);
vec4 imageLoad(image2DMS image, ivec2 P, int sample_);
vec4 imageLoad(iimage2DMS image, ivec2 P, int sample_);
vec4 imageLoad(uimage2DMS image, ivec2 P, int sample_);
ivec4 imageLoad(image2DMS image, ivec2 P, int sample_);
ivec4 imageLoad(iimage2DMS image, ivec2 P, int sample_);
ivec4 imageLoad(uimage2DMS image, ivec2 P, int sample_);
uvec4 imageLoad(image2DMS image, ivec2 P, int sample_);
uvec4 imageLoad(iimage2DMS image, ivec2 P, int sample_);
uvec4 imageLoad(uimage2DMS image, ivec2 P, int sample_);
dvec4 imageLoad(image2DMS image, ivec2 P, int sample_);
dvec4 imageLoad(iimage2DMS image, ivec2 P, int sample_);
dvec4 imageLoad(uimage2DMS image, ivec2 P, int sample_);
vec4 imageLoad(image2DMSArray image, ivec3 P, int sample_);
vec4 imageLoad(iimage2DMSArray image, ivec3 P, int sample_);
vec4 imageLoad(uimage2DMSArray image, ivec3 P, int sample_);
ivec4 imageLoad(image2DMSArray image, ivec3 P, int sample_);
ivec4 imageLoad(iimage2DMSArray image, ivec3 P, int sample_);
ivec4 imageLoad(uimage2DMSArray image, ivec3 P, int sample_);
uvec4 imageLoad(image2DMSArray image, ivec3 P, int sample_);
uvec4 imageLoad(iimage2DMSArray image, ivec3 P, int sample_);
uvec4 imageLoad(uimage2DMSArray image, ivec3 P, int sample_);
dvec4 imageLoad(image2DMSArray image, ivec3 P, int sample_);
dvec4 imageLoad(iimage2DMSArray image, ivec3 P, int sample_);
dvec4 imageLoad(uimage2DMSArray image, ivec3 P, int sample_);
...
void imageStore(image1D image, int P, ivec4 data);
void imageStore(image1D image, int P, uvec4 data);
void imageStore(image1D image, int P, dvec4 data);
void imageStore(iimage1D image, int P, vec4 data);
void imageStore(iimage1D image, int P, ivec4 data);
void imageStore(iimage1D image, int P, uvec4 data);
void imageStore(iimage1D image, int P, dvec4 data);
void imageStore(uimage1D image, int P, vec4 data);
void imageStore(uimage1D image, int P, ivec4 data);
void imageStore(uimage1D image, int P, uvec4 data);
void imageStore(uimage1D image, int P, dvec4 data);
void imageStore(image2D image, ivec2 P, vec4 data);
void imageStore(image2D image, ivec2 P, ivec4 data);
void imageStore(image2D image, ivec2 P, uvec4 data);
void imageStore(image2D image, ivec2 P, dvec4 data);
void imageStore(iimage2D image, ivec2 P, vec4 data);
void imageStore(iimage2D image, ivec2 P, ivec4 data);
void imageStore(iimage2D image, ivec2 P, uvec4 data);
void imageStore(iimage2D image, ivec2 P, dvec4 data);
void imageStore(uimage2D image, ivec2 P, vec4 data);
void imageStore(uimage2D image, ivec2 P, ivec4 data);
void imageStore(uimage2D image, ivec2 P, uvec4 data);
void imageStore(uimage2D image, ivec2 P, dvec4 data);
void imageStore(image3D image, ivec3 P, vec4 data);
void imageStore(image3D image, ivec3 P, ivec4 data);
void imageStore(image3D image, ivec3 P, uvec4 data);
void imageStore(image3D image, ivec3 P, dvec4 data);
void imageStore(iimage3D image, ivec3 P, vec4 data);
void imageStore(iimage3D image, ivec3 P, ivec4 data);
void imageStore(iimage3D image, ivec3 P, uvec4 data);
void imageStore(iimage3D image, ivec3 P, dvec4 data);
void imageStore(uimage3D image, ivec3 P, vec4 data);
void imageStore(uimage3D image, ivec3 P, ivec4 data);
void imageStore(uimage3D image, ivec3 P, uvec4 data);
void imageStore(uimage3D image, ivec3 P, dvec4 data);
void imageStore(image2DRect image, ivec2 P, vec4 data);
void imageStore(image2DRect image, ivec2 P, ivec4 data);
void imageStore(image2DRect image, ivec2 P, uvec4 data);
void imageStore(image2DRect image, ivec2 P, dvec4 data);
void imageStore(iimage2DRect image, ivec2 P, vec4 data);
void imageStore(iimage2DRect image, ivec2 P, ivec4 data);
void imageStore(iimage2DRect image, ivec2 P, uvec4 data);
void imageStore(iimage2DRect image, ivec2 P, dvec4 data);
void imageStore(uimage2DRect image, ivec2 P, vec4 data);
void imageStore(uimage2DRect image, ivec2 P, ivec4 data);
void imageStore(uimage2DRect image, ivec2 P, uvec4 data);
void imageStore(uimage2DRect image, ivec2 P, dvec4 data);
void imageStore(imageCube image, ivec3 P, vec4 data);
void imageStore(imageCube image, ivec3 P, ivec4 data);
void imageStore(imageCube image, ivec3 P, uvec4 data);
void imageStore(imageCube image, ivec3 P, dvec4 data);
void imageStore(iimageCube image, ivec3 P, vec4 data);
void imageStore(iimageCube image, ivec3 P, ivec4 data);
void imageStore(iimageCube image, ivec3 P, uvec4 data);
void imageStore(iimageCube image, ivec3 P, dvec4 data);
void imageStore(uimageCube image, ivec3 P, vec4 data);
void imageStore(uimageCube image, ivec3 P, ivec4 data);
void imageStore(uimageCube image, ivec3 P, uvec4 data);
void imageStore(uimageCube image, ivec3 P, dvec4 data);
void imageStore(imageBuffer image, int P, vec4 data);
void imageStore(imageBuffer image, int P, ivec4 data);
void imageStore(imageBuffer image, int P, uvec4 data);
void imageStore(imageBuffer image, int P, dvec4 data);
void imageStore(iimageBuffer image, int P, vec4 data);
void imageStore(iimageBuffer image, int P, ivec4 data);
void imageStore(iimageBuffer image, int P, uvec4 data);
void imageStore(iimageBuffer image, int P, dvec4 data);
void imageStore(uimageBuffer image, int P, vec4 data);
void imageStore(uimageBuffer image, int P, ivec4 data);
void imageStore(uimageBuffer image, int P, uvec4 data);
void imageStore(uimageBuffer image, int P, dvec4 data);
void imageStore(image1DArray image, ivec2 P, vec4 data);
void imageStore(image1DArray image, ivec2 P, ivec4 data);
void imageStore(image1DArray image, ivec2 P, uvec4 data);
void imageStore(image1DArray image, ivec2 P, dvec4 data);
void imageStore(iimage1DArray image, ivec2 P, vec4 data);
void imageStore(iimage1DArray image, ivec2 P, ivec4 data);
void imageStore(iimage1DArray image, ivec2 P, uvec4 data);
void imageStore(iimage1DArray image, ivec2 P, dvec4 data);
void imageStore(uimage1DArray image, ivec2 P, vec4 data);
void imageStore(uimage1DArray image, ivec2 P, ivec4 data);
void imageStore(uimage1DArray image, ivec2 P, uvec4 data);
void imageStore(uimage1DArray image, ivec2 P, dvec4 data);
void imageStore(image2DArray image, ivec3 P, vec4 data);
void imageStore(image2DArray image, ivec3 P, ivec4 data);
void imageStore(image2DArray image, ivec3 P, uvec4 data);
void imageStore(image2DArray image, ivec3 P, dvec4 data);
void imageStore(iimage2DArray image, ivec3 P, vec4 data);
void imageStore(iimage2DArray image, ivec3 P, ivec4 data);
void imageStore(iimage2DArray image, ivec3 P, uvec4 data);
void imageStore(iimage2DArray image, ivec3 P, dvec4 data);
void imageStore(uimage2DArray image, ivec3 P, vec4 data);
void imageStore(uimage2DArray image, ivec3 P, ivec4 data);
void imageStore(uimage2DArray image, ivec3 P, uvec4 data);
void imageStore(uimage2DArray image, ivec3 P, dvec4 data);
void imageStore(imageCubeArray image, ivec3 P, vec4 data);
void imageStore(imageCubeArray image, ivec3 P, ivec4 data);
void imageStore(imageCubeArray image, ivec3 P, uvec4 data);
void imageStore(imageCubeArray image, ivec3 P, dvec4 data);
void imageStore(iimageCubeArray image, ivec3 P, vec4 data);
void imageStore(iimageCubeArray image, ivec3 P, ivec4 data);
void imageStore(iimageCubeArray image, ivec3 P, uvec4 data);
void imageStore(iimageCubeArray image, ivec3 P, dvec4 data);
void imageStore(uimageCubeArray image, ivec3 P, vec4 data);
void imageStore(uimageCubeArray image, ivec3 P, ivec4 data);
void imageStore(uimageCubeArray image, ivec3 P, uvec4 data);
void imageStore(uimageCubeArray image, ivec3 P, dvec4 data);
void imageStore(image2DMS image, ivec2 P, int sample_, vec4 data);
void imageStore(image2DMS image, ivec2 P, int sample_, ivec4 data);
void imageStore(image2DMS image, ivec2 P, int sample_, uvec4 data);
void imageStore(image2DMS image, ivec2 P, int sample_, dvec4 data);
void imageStore(iimage2DMS image, ivec2 P, int sample_, vec4 data);
void imageStore(iimage2DMS image, ivec2 P, int sample_, ivec4 data);
void imageStore(iimage2DMS image, ivec2 P, int sample_, uvec4 data);
void imageStore(iimage2DMS image, ivec2 P, int sample_, dvec4 data);
void imageStore(uimage2DMS image, ivec2 P, int sample_, vec4 data);
void imageStore(uimage2DMS image, ivec2 P, int sample_, ivec4 data);
void imageStore(uimage2DMS image, ivec2 P, int sample_, uvec4 data);
void imageStore(uimage2DMS image, ivec2 P, int sample_, dvec4 data);
void imageStore(image2DMSArray image, ivec3 P, int sample_, vec4 data);
void imageStore(image2DMSArray image, ivec3 P, int sample_, ivec4 data);
void imageStore(image2DMSArray image, ivec3 P, int sample_, uvec4 data);
void imageStore(image2DMSArray image, ivec3 P, int sample_, dvec4 data);
void imageStore(iimage2DMSArray image, ivec3 P, int sample_, vec4 data);
void imageStore(iimage2DMSArray image, ivec3 P, int sample_, ivec4 data);
void imageStore(iimage2DMSArray image, ivec3 P, int sample_, uvec4 data);
void imageStore(iimage2DMSArray image, ivec3 P, int sample_, dvec4 data);
void imageStore(uimage2DMSArray image, ivec3 P, int sample_, vec4 data);
void imageStore(uimage2DMSArray image, ivec3 P, int sample_, ivec4 data);
void imageStore(uimage2DMSArray image, ivec3 P, int sample_, uvec4 data);
void imageStore(uimage2DMSArray image, ivec3 P, int sample_, dvec4 data);

float intBitsToFloat(int x);
float intBitsToFloat(ivec2 x);
float intBitsToFloat(ivec3 x);
float intBitsToFloat(ivec4 x);
vec2 intBitsToFloat(int x);
vec2 intBitsToFloat(ivec2 x);
vec2 intBitsToFloat(ivec3 x);
vec2 intBitsToFloat(ivec4 x);
vec3 intBitsToFloat(int x);
vec3 intBitsToFloat(ivec2 x);
vec3 intBitsToFloat(ivec3 x);
vec3 intBitsToFloat(ivec4 x);
vec4 intBitsToFloat(int x);
vec4 intBitsToFloat(ivec2 x);
vec4 intBitsToFloat(ivec3 x);
vec4 intBitsToFloat(ivec4 x);

float uintBitsToFloat(uint x);
float uintBitsToFloat(uvec2 x);
float uintBitsToFloat(uvec3 x);
float uintBitsToFloat(uvec4 x);
vec2 uintBitsToFloat(uint x);
vec2 uintBitsToFloat(uvec2 x);
vec2 uintBitsToFloat(uvec3 x);
vec2 uintBitsToFloat(uvec4 x);
vec3 uintBitsToFloat(uint x);
vec3 uintBitsToFloat(uvec2 x);
vec3 uintBitsToFloat(uvec3 x);
vec3 uintBitsToFloat(uvec4 x);
vec4 uintBitsToFloat(uint x);
vec4 uintBitsToFloat(uvec2 x);
vec4 uintBitsToFloat(uvec3 x);
...
float ldexp(float x, ivec2 exp);
float ldexp(float x, ivec3 exp);
float ldexp(float x, ivec4 exp);
vec2 ldexp(vec2 x, int exp);
vec2 ldexp(vec2 x, ivec2 exp);
vec2 ldexp(vec2 x, ivec3 exp);
vec2 ldexp(vec2 x, ivec4 exp);
vec3 ldexp(vec3 x, int exp);
vec3 ldexp(vec3 x, ivec2 exp);
vec3 ldexp(vec3 x, ivec3 exp);
vec3 ldexp(vec3 x, ivec4 exp);
vec4 ldexp(vec4 x, int exp);
vec4 ldexp(vec4 x, ivec2 exp);
vec4 ldexp(vec4 x, ivec3 exp);
...
vec4 texelFetch(isampler2DMS sampler, ivec2 P, int sample_);
vec4 texelFetch(usampler2DMS sampler, ivec2 P, int sample_);
ivec4 texelFetch(sampler2DMS sampler, ivec2 P, int sample_);
ivec4 texelFetch(isampler2DMS sampler, ivec2 P, int sample_);
ivec4 texelFetch(usampler2DMS sampler, ivec2 P, int sample_);
uvec4 texelFetch(sampler2DMS sampler, ivec2 P, int sample_);
uvec4 texelFetch(isampler2DMS sampler, ivec2 P, int sample_);
uvec4 texelFetch(usampler2DMS sampler, ivec2 P, int sample_);
dvec4 texelFetch(sampler2DMS sampler, ivec2 P, int sample_);
dvec4 texelFetch(isampler2DMS sampler, ivec2 P, int sample_);
dvec4 texelFetch(usampler2DMS sampler, ivec2 P, int sample_);
vec4 texelFetch(sampler2DMSArray sampler, ivec3 P, int sample_);
vec4 texelFetch(isampler2DMSArray sampler, ivec3 P, int sample_);
vec4 texelFetch(usampler2DMSArray sampler, ivec3 P, int sample_);
ivec4 texelFetch(sampler2DMSArray sampler, ivec3 P, int sample_);
ivec4 texelFetch(isampler2DMSArray sampler, ivec3 P, int sample_);
ivec4 texelFetch(usampler2DMSArray sampler, ivec3 P, int sample_);
uvec4 texelFetch(sampler2DMSArray sampler, ivec3 P, int sample_);
uvec4 texelFetch(isampler2DMSArray sampler, ivec3 P, int sample_);
uvec4 texelFetch(usampler2DMSArray sampler, ivec3 P, int sample_);
dvec4 texelFetch(sampler2DMSArray sampler, ivec3 P, int sample_);
dvec4 texelFetch(isampler2DMSArray sampler, ivec3 P, int sample_);
dvec4 texelFetch(usampler2DMSArray sampler, ivec3 P, int sample_);
...
vec4 texelFetchOffset(isampler1DArray sampler, ivec2 P, int lod, ivec2 offset);
vec4 texelFetchOffset(usampler1DArray sampler, ivec2 P, int lod, ivec2 offset);
ivec4 texelFetchOffset(sampler1DArray sampler, ivec2 P, int lod, ivec2 offset);
ivec4 texelFetchOffset(isampler1DArray sampler, ivec2 P, int lod, ivec2 offset);
ivec4 texelFetchOffset(usampler1DArray sampler, ivec2 P, int lod, ivec2 offset);
uvec4 texelFetchOffset(sampler1DArray sampler, ivec2 P, int lod, ivec2 offset);
uvec4 texelFetchOffset(isampler1DArray sampler, ivec2 P, int lod, ivec2 offset);
uvec4 texelFetchOffset(usampler1DArray sampler, ivec2 P, int lod, ivec2 offset);
dvec4 texelFetchOffset(sampler1DArray sampler, ivec2 P, int lod, ivec2 offset);
dvec4 texelFetchOffset(isampler1DArray sampler, ivec2 P, int lod, ivec2 offset);
dvec4 texelFetchOffset(usampler1DArray sampler, ivec2 P, int lod, ivec2 offset);
vec4 texelFetchOffset(sampler2DArray sampler, ivec3 P, int lod, ivec3 offset);
vec4 texelFetchOffset(isampler2DArray sampler, ivec3 P, int lod, ivec3 offset);
vec4 texelFetchOffset(usampler2DArray sampler, ivec3 P, int lod, ivec3 offset);
ivec4 texelFetchOffset(sampler2DArray sampler, ivec3 P, int lod, ivec3 offset);
ivec4 texelFetchOffset(isampler2DArray sampler, ivec3 P, int lod, ivec3 offset);
ivec4 texelFetchOffset(usampler2DArray sampler, ivec3 P, int lod, ivec3 offset);
uvec4 texelFetchOffset(sampler2DArray sampler, ivec3 P, int lod, ivec3 offset);
uvec4 texelFetchOffset(isampler2DArray sampler, ivec3 P, int lod, ivec3 offset);
uvec4 texelFetchOffset(usampler2DArray sampler, ivec3 P, int lod, ivec3 offset);
dvec4 texelFetchOffset(sampler2DArray sampler, ivec3 P, int lod, ivec3 offset);
dvec4 texelFetchOffset(isampler2DArray sampler, ivec3 P, int lod, ivec3 offset);
dvec4 texelFetchOffset(usampler2DArray sampler, ivec3 P, int lod, ivec3 offset);
...
vec4 textureGather(isampler2DRect sampler, vec3 P, int comp);
vec4 textureGather(isampler2DRect sampler, vec3 P);
vec4 textureGather(usampler2DRect sampler, vec3 P, int comp);
vec4 textureGather(usampler2DRect sampler, vec3 P);
ivec4 textureGather(sampler2DRect sampler, vec3 P, int comp);
ivec4 textureGather(sampler2DRect sampler, vec3 P);
ivec4 textureGather(isampler2DRect sampler, vec3 P, int comp);
ivec4 textureGather(isampler2DRect sampler, vec3 P);
ivec4 textureGather(usampler2DRect sampler, vec3 P, int comp);
ivec4 textureGather(usampler2DRect sampler, vec3 P);
uvec4 textureGather(sampler2DRect sampler, vec3 P, int comp);
uvec4 textureGather(sampler2DRect sampler, vec3 P);
uvec4 textureGather(isampler2DRect sampler, vec3 P, int comp);
uvec4 textureGather(isampler2DRect sampler, vec3 P);
uvec4 textureGather(usampler2DRect sampler, vec3 P, int comp);
uvec4 textureGather(usampler2DRect sampler, vec3 P);
dvec4 textureGather(sampler2DRect sampler, vec3 P, int comp);
dvec4 textureGather(sampler2DRect sampler, vec3 P);
dvec4 textureGather(isampler2DRect sampler, vec3 P, int comp);
dvec4 textureGather(isampler2DRect sampler, vec3 P);
dvec4 textureGather(usampler2DRect sampler, vec3 P, int comp);
dvec4 textureGather(usampler2DRect sampler, vec3 P);
...
vec4 textureGatherOffset(isampler2DRect sampler, vec3 P, ivec2 offset, int comp);
vec4 textureGatherOffset(isampler2DRect sampler, vec3 P, ivec2 offset);
vec4 textureGatherOffset(usampler2DRect sampler, vec3 P, ivec2 offset, int comp);
vec4 textureGatherOffset(usampler2DRect sampler, vec3 P, ivec2 offset);
ivec4 textureGatherOffset(sampler2DRect sampler, vec3 P, ivec2 offset, int comp);
ivec4 textureGatherOffset(sampler2DRect sampler, vec3 P, ivec2 offset);
...
ivec4 textureGatherOffset(usampler2DRect sampler, vec3 P, ivec2 offset, int comp);
ivec4 textureGatherOffset(usampler2DRect sampler, vec3 P, ivec2 offset);
uvec4 textureGatherOffset(sampler2DRect sampler, vec3 P, ivec2 offset, int comp);
uvec4 textureGatherOffset(sampler2DRect sampler, vec3 P, ivec2 offset);
uvec4 textureGatherOffset(isampler2DRect sampler, vec3 P, ivec2 offset, int comp);
uvec4 textureGatherOffset(isampler2DRect sampler, vec3 P, ivec2 offset);
...
dvec4 textureGatherOffset(sampler2DRect sampler, vec3 P, ivec2 offset, int comp);
dvec4 textureGatherOffset(sampler2DRect sampler, vec3 P, ivec2 offset);
dvec4 textureGatherOffset(isampler2DRect sampler, vec3 P, ivec2 offset, int comp);
dvec4 textureGatherOffset(isampler2DRect sampler, vec3 P, ivec2 offset);
dvec4 textureGatherOffset(usampler2DRect sampler, vec3 P, ivec2 offset, int comp);
dvec4 textureGatherOffset(usampler2DRect sampler, vec3 P, ivec2 offset);
...
vec4 textureGatherOffsets(isampler2DRect sampler, vec3 P, ivec2 offsets[4], int comp);
vec4 textureGatherOffsets(isampler2DRect sampler, vec3 P, ivec2 offsets[4]);
vec4 textureGatherOffsets(usampler2DRect sampler, vec3 P, ivec2 offsets[4], int comp);
vec4 textureGatherOffsets(usampler2DRect sampler, vec3 P, ivec2 offsets[4]);
ivec4 textureGatherOffsets(sampler2DRect sampler, vec3 P, ivec2 offsets[4], int comp);
ivec4 textureGatherOffsets(sampler2DRect sampler, vec3 P, ivec2 offsets[4]);
ivec4 textureGatherOffsets(isampler2DRect sampler, vec3 P, ivec2 offsets[4], int comp);
ivec4 textureGatherOffsets(isampler2DRect sampler, vec3 P, ivec2 offsets[4]);
ivec4 textureGatherOffsets(usampler2DRect sampler, vec3 P, ivec2 offsets[4], int comp);
ivec4 textureGatherOffsets(usampler2DRect sampler, vec3 P, ivec2 offsets[4]);
uvec4 textureGatherOffsets(sampler2DRect sampler, vec3 P, ivec2 offsets[4], int comp);
uvec4 textureGatherOffsets(sampler2DRect sampler, vec3 P, ivec2 offsets[4]);
uvec4 textureGatherOffsets(isampler2DRect sampler, vec3 P, ivec2 offsets[4], int comp);
uvec4 textureGatherOffsets(isampler2DRect sampler, vec3 P, ivec2 offsets[4]);
uvec4 textureGatherOffsets(usampler2DRect sampler, vec3 P, ivec2 offsets[4], int comp);
uvec4 textureGatherOffsets(usampler2DRect sampler, vec3 P, ivec2 offsets[4]);
dvec4 textureGatherOffsets(sampler2DRect sampler, vec3 P, ivec2 offsets[4], int comp);
dvec4 textureGatherOffsets(sampler2DRect sampler, vec3 P, ivec2 offsets[4]);
dvec4 textureGatherOffsets(isampler2DRect sampler, vec3 P, ivec2 offsets[4], int comp);
dvec4 textureGatherOffsets(isampler2DRect sampler, vec3 P, ivec2 offsets[4]);
dvec4 textureGatherOffsets(usampler2DRect sampler, vec3 P, ivec2 offsets[4], int comp);
dvec4 textureGatherOffsets(usampler2DRect sampler, vec3 P, ivec2 offsets[4]);
...
vec4 textureGrad(isampler1D sampler, float P, float dPdx, float dPdy);
vec4 textureGrad(usampler1D sampler, float P, float dPdx, float dPdy);
ivec4 textureGrad(sampler1D sampler, float P, float dPdx, float dPdy);
ivec4 textureGrad(isampler1D sampler, float P, float dPdx, float dPdy);
ivec4 textureGrad(usampler1D sampler, float P, float dPdx, float dPdy);
uvec4 textureGrad(sampler1D sampler, float P, float dPdx, float dPdy);
uvec4 textureGrad(isampler1D sampler, float P, float dPdx, float dPdy);
uvec4 textureGrad(usampler1D sampler, float P, float dPdx, float dPdy);
dvec4 textureGrad(sampler1D sampler, float P, float dPdx, float dPdy);
dvec4 textureGrad(isampler1D sampler, float P, float dPdx, float dPdy);
dvec4 textureGrad(usampler1D sampler, float P, float dPdx, float dPdy);
...
vec4 textureGrad(isampler3D sampler, vec3 P, vec3 dPdx, vec3 dPdy);
vec4 textureGrad(usampler3D sampler, vec3 P, vec3 dPdx, vec3 dPdy);
ivec4 textureGrad(sampler3D sampler, vec3 P, vec3 dPdx, vec3 dPdy);
ivec4 textureGrad(isampler3D sampler, vec3 P, vec3 dPdx, vec3 dPdy);
ivec4 textureGrad(usampler3D sampler, vec3 P, vec3 dPdx, vec3 dPdy);
uvec4 textureGrad(sampler3D sampler, vec3 P, vec3 dPdx, vec3 dPdy);
uvec4 textureGrad(isampler3D sampler, vec3 P, vec3 dPdx, vec3 dPdy);
uvec4 textureGrad(usampler3D sampler, vec3 P, vec3 dPdx, vec3 dPdy);
dvec4 textureGrad(sampler3D sampler, vec3 P, vec3 dPdx, vec3 dPdy);
dvec4 textureGrad(isampler3D sampler, vec3 P, vec3 dPdx, vec3 dPdy);
dvec4 textureGrad(usampler3D sampler, vec3 P, vec3 dPdx, vec3 dPdy);
...
vec4 textureProjGrad(isampler1D sampler, vec2 P, float pDx, float pDy);
vec4 textureProjGrad(usampler1D sampler, vec2 P, float pDx, float pDy);
ivec4 textureProjGrad(sampler1D sampler, vec2 P, float pDx, float pDy);
ivec4 textureProjGrad(isampler1D sampler, vec2 P, float pDx, float pDy);
ivec4 textureProjGrad(usampler1D sampler, vec2 P, float pDx, float pDy);
uvec4 textureProjGrad(sampler1D sampler, vec2 P, float pDx, float pDy);
uvec4 textureProjGrad(isampler1D sampler, vec2 P, float pDx, float pDy);
uvec4 textureProjGrad(usampler1D sampler, vec2 P, float pDx, float pDy);
dvec4 textureProjGrad(sampler1D sampler, vec2 P, float pDx, float pDy);
dvec4 textureProjGrad(isampler1D sampler, vec2 P, float pDx, float pDy);
dvec4 textureProjGrad(usampler1D sampler, vec2 P, float pDx, float pDy);
vec4 textureProjGrad(sampler1D sampler, vec4 P, float pDx, float pDy);
vec4 textureProjGrad(isampler1D sampler, vec4 P, float pDx, float pDy);
vec4 textureProjGrad(usampler1D sampler, vec4 P, float pDx, float pDy);
ivec4 textureProjGrad(sampler1D sampler, vec4 P, float pDx, float pDy);
ivec4 textureProjGrad(isampler1D sampler, vec4 P, float pDx, float pDy);
ivec4 textureProjGrad(usampler1D sampler, vec4 P, float pDx, float pDy);
uvec4 textureProjGrad(sampler1D sampler, vec4 P, float pDx, float pDy);
uvec4 textureProjGrad(isampler1D sampler, vec4 P, float pDx, float pDy);
uvec4 textureProjGrad(usampler1D sampler, vec4 P, float pDx, float pDy);
dvec4 textureProjGrad(sampler1D sampler, vec4 P, float pDx, float pDy);
dvec4 textureProjGrad(isampler1D sampler, vec4 P, float pDx, float pDy);
dvec4 textureProjGrad(usampler1D sampler, vec4 P, float pDx, float pDy);
vec4 textureProjGrad(sampler2D sampler, vec3 P, vec2 pDx, vec2 pDy);
vec4 textureProjGrad(isampler2D sampler, vec3 P, vec2 pDx, vec2 pDy);
vec4 textureProjGrad(usampler2D sampler, vec3 P, vec2 pDx, vec2 pDy);
ivec4 textureProjGrad(sampler2D sampler, vec3 P, vec2 pDx, vec2 pDy);
ivec4 textureProjGrad(isampler2D sampler, vec3 P, vec2 pDx, vec2 pDy);
ivec4 textureProjGrad(usampler2D sampler, vec3 P, vec2 pDx, vec2 pDy);
uvec4 textureProjGrad(sampler2D sampler, vec3 P, vec2 pDx, vec2 pDy);
uvec4 textureProjGrad(isampler2D sampler, vec3 P, vec2 pDx, vec2 pDy);
uvec4 textureProjGrad(usampler2D sampler, vec3 P, vec2 pDx, vec2 pDy);
dvec4 textureProjGrad(sampler2D sampler, vec3 P, vec2 pDx, vec2 pDy);
dvec4 textureProjGrad(isampler2D sampler, vec3 P, vec2 pDx, vec2 pDy);
dvec4 textureProjGrad(usampler2D sampler, vec3 P, vec2 pDx, vec2 pDy);
vec4 textureProjGrad(sampler2D sampler, vec4 P, vec2 pDx, vec2 pDy);
vec4 textureProjGrad(isampler2D sampler, vec4 P, vec2 pDx, vec2 pDy);
vec4 textureProjGrad(usampler2D sampler, vec4 P, vec2 pDx, vec2 pDy);
ivec4 textureProjGrad(sampler2D sampler, vec4 P, vec2 pDx, vec2 pDy);
ivec4 textureProjGrad(isampler2D sampler, vec4 P, vec2 pDx, vec2 pDy);
ivec4 textureProjGrad(usampler2D sampler, vec4 P, vec2 pDx, vec2 pDy);
uvec4 textureProjGrad(sampler2D sampler, vec4 P, vec2 pDx, vec2 pDy);
uvec4 textureProjGrad(isampler2D sampler, vec4 P, vec2 pDx, vec2 pDy);
uvec4 textureProjGrad(usampler2D sampler, vec4 P, vec2 pDx, vec2 pDy);
dvec4 textureProjGrad(sampler2D sampler, vec4 P, vec2 pDx, vec2 pDy);
dvec4 textureProjGrad(isampler2D sampler, vec4 P, vec2 pDx, vec2 pDy);
dvec4 textureProjGrad(usampler2D sampler, vec4 P, vec2 pDx, vec2 pDy);
vec4 textureProjGrad(sampler3D sampler, vec4 P, vec3 pDx, vec3 pDy);
vec4 textureProjGrad(isampler3D sampler, vec4 P, vec3 pDx, vec3 pDy);
vec4 textureProjGrad(usampler3D sampler, vec4 P, vec3 pDx, vec3 pDy);
ivec4 textureProjGrad(sampler3D sampler, vec4 P, vec3 pDx, vec3 pDy);
ivec4 textureProjGrad(isampler3D sampler, vec4 P, vec3 pDx, vec3 pDy);
ivec4 textureProjGrad(usampler3D sampler, vec4 P, vec3 pDx, vec3 pDy);
uvec4 textureProjGrad(sampler3D sampler, vec4 P, vec3 pDx, vec3 pDy);
uvec4 textureProjGrad(isampler3D sampler, vec4 P, vec3 pDx, vec3 pDy);
uvec4 textureProjGrad(usampler3D sampler, vec4 P, vec3 pDx, vec3 pDy);
dvec4 textureProjGrad(sampler3D sampler, vec4 P, vec3 pDx, vec3 pDy);
dvec4 textureProjGrad(isampler3D sampler, vec4 P, vec3 pDx, vec3 pDy);
dvec4 textureProjGrad(usampler3D sampler, vec4 P, vec3 pDx, vec3 pDy);
...
vec4 textureProjGrad(isampler2DRect sampler, vec3 P, vec2 pDx, vec2 pDy);
vec4 textureProjGrad(usampler2DRect sampler, vec3 P, vec2 pDx, vec2 pDy);
ivec4 textureProjGrad(sampler2DRect sampler, vec3 P, vec2 pDx, vec2 pDy);
ivec4 textureProjGrad(isampler2DRect sampler, vec3 P, vec2 pDx, vec2 pDy);
ivec4 textureProjGrad(usampler2DRect sampler, vec3 P, vec2 pDx, vec2 pDy);
uvec4 textureProjGrad(sampler2DRect sampler, vec3 P, vec2 pDx, vec2 pDy);
uvec4 textureProjGrad(isampler2DRect sampler, vec3 P, vec2 pDx, vec2 pDy);
uvec4 textureProjGrad(usampler2DRect sampler, vec3 P, vec2 pDx, vec2 pDy);
dvec4 textureProjGrad(sampler2DRect sampler, vec3 P, vec2 pDx, vec2 pDy);
dvec4 textureProjGrad(isampler2DRect sampler, vec3 P, vec2 pDx, vec2 pDy);
dvec4 textureProjGrad(usampler2DRect sampler, vec3 P, vec2 pDx, vec2 pDy);
vec4 textureProjGrad(sampler2DRect sampler, vec4 P, vec2 pDx, vec2 pDy);
vec4 textureProjGrad(isampler2DRect sampler, vec4 P, vec2 pDx, vec2 pDy);
vec4 textureProjGrad(usampler2DRect sampler, vec4 P, vec2 pDx, vec2 pDy);
ivec4 textureProjGrad(sampler2DRect sampler, vec4 P, vec2 pDx, vec2 pDy);
ivec4 textureProjGrad(isampler2DRect sampler, vec4 P, vec2 pDx, vec2 pDy);
ivec4 textureProjGrad(usampler2DRect sampler, vec4 P, vec2 pDx, vec2 pDy);
uvec4 textureProjGrad(sampler2DRect sampler, vec4 P, vec2 pDx, vec2 pDy);
uvec4 textureProjGrad(isampler2DRect sampler, vec4 P, vec2 pDx, vec2 pDy);
uvec4 textureProjGrad(usampler2DRect sampler, vec4 P, vec2 pDx, vec2 pDy);
dvec4 textureProjGrad(sampler2DRect sampler, vec4 P, vec2 pDx, vec2 pDy);
dvec4 textureProjGrad(isampler2DRect sampler, vec4 P, vec2 pDx, vec2 pDy);
dvec4 textureProjGrad(usampler2DRect sampler, vec4 P, vec2 pDx, vec2 pDy);
