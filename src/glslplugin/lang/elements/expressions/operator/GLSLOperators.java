...
public final class GLSLOperators {
    ...
    public static final GLSLAssignmentOperator ADDITION_ASSIGN = new BinaryOperatorAssingnmentOperator("+=", ADDITION);
    public static final GLSLAssignmentOperator SUBTRACTION_ASSIGN = new BinaryOperatorAssingnmentOperator("-=", SUBTRACTION);
    public static final GLSLAssignmentOperator MULTIPLICATION_ASSIGN = new BinaryOperatorAssingnmentOperator("*=", MULTIPLICATION);
    public static final GLSLAssignmentOperator DIVISION_ASSIGN = new BinaryOperatorAssingnmentOperator("/=", DIVISION);
    public static final GLSLAssignmentOperator MODULO_ASSIGN = new BinaryOperatorAssingnmentOperator("%=", MODULO);
    public static final GLSLAssignmentOperator LEFT_SHIFT_ASSIGN = new BinaryOperatorAssingnmentOperator("<<=", BINARY_LEFT_SHIFT);
    public static final GLSLAssignmentOperator RIGHT_SHIFT_ASSIGN = new BinaryOperatorAssingnmentOperator(">>=", BINARY_RIGHT_SHIFT);
    public static final GLSLAssignmentOperator BINARY_AND_ASSIGN = new BinaryOperatorAssingnmentOperator("&=", BINARY_AND);
    public static final GLSLAssignmentOperator BINARY_XOR_ASSIGN = new BinaryOperatorAssingnmentOperator("^=", BINARY_XOR);
    public static final GLSLAssignmentOperator BINARY_OR_ASSIGN = new BinaryOperatorAssingnmentOperator("|=", BINARY_OR);
